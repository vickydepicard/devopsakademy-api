// src/app.ts — MODIFIÉ : ajout de reviewRoutes
...
import reviewRoutes        from "./routes/reviews.routes"; // ✅ NOUVEAU
...
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  if (openRoutes.some(route => req.originalUrl.startsWith(route))) return next();
...
app.use("/api/courses",       reviewRoutes);  // ✅ NOUVEAU : /api/courses/:courseId/reviews
